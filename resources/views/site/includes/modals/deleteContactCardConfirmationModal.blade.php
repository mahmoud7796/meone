<div class="modal fade" id="modaldelete-3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div style="text-align: center">
                    <input type="hidden" id="deleteCardContactId">
                <button id="confirmCardContactDelete" aria-hidden="true" type="button" class="btn btn-danger">Yes</button>
